 ...
 *
 * ```php
 * use kuakling\materialize\ActiveForm;
 *
 * $form = ActiveForm::begin(['layout' => 'horizontal'])
 * ```
 *
 * This will set default values for the [[kuakling\materialize\ActiveField|ActiveField]]
 * to render horizontal form fields. In particular the [[kuakling\materialize\ActiveField::template|template]]
 * is set to `{label} {beginWrapper} {input} {error} {endWrapper} {hint}` and the
 * [[kuakling\materialize\ActiveField::horizontalCssClasses|horizontalCssClasses]] are set to:
 *
 * ```php
 * [
 ...
 * ```
 *
 * @see \kuakling\materialize\ActiveField for details on the [[fieldConfig]] options
...
class ActiveForm extends \yii\widgets\ActiveForm
{
     ...
     * @see fieldConfig
     */
    public $fieldClass = 'kuakling\materialize\ActiveField';
    /**
