...
namespace kuakling\materialize\grid;

use Yii;
use yii\i18n\Formatter;
use yii\base\InvalidConfigException;
use yii\grid\GridView as BootstrapGridView;
 ...
 * @since 2.0
 */
class GridView extends BootstrapGridView
{
    public $prevPageCssClass = 'aaaaa';
     ...
     * @see \yii\helpers\Html::renderTagAttributes() for details on how attributes are being rendered.
     */
    //public $tableOptions = ['class' => 'striped bordered'];
    /**
    ...
    {
        //$this->pager->LinkPager->prevPageCssClass = 'sdgfsh';
        $this->tableOptions = ['class' => 'striped bordered'];
        $this->dataColumnClass = 'kuakling\materialize\grid\DataColumn';
        $this->pager['class'] = 'kuakling\materialize\widgets\LinkPager';
        parent::init();
