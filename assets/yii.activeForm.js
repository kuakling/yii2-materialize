...
(function ($) {
    ...
    var updateInput = function ($form, attribute, messages) {
        ...
        if ($input.length) {
            ...
            if (hasError) {
                $container.children('label').attr('data-error', messages[attribute.id][0]);
                //$container.children('label').attr('data-success', 'right');
                ...
                $container.children('input').addClass('validate invalid');
            } else {
                $error.empty();
                //$container.removeClass(data.settings.validatingCssClass + ' ' + data.settings.errorCssClass + ' ')
                //    .addClass(data.settings.successCssClass);
                $container.children('input').removeClass('validate invalid');
            }
